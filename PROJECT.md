...
- Ligne de seuil : [knockout typographique](./docs/glossaire.md#knockout-typographique) — la ligne s'interrompt autour du score (12 px de marge, centrage via `actualBoundingBoxAscent`). Validé (D06).
